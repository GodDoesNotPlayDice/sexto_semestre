...
|_      EDB-ID:36742    0.0     https://vulners.com/exploitdb/EDB-ID:36742      *EXPLOIT*
...
| http-dombased-xss: 
| Spidering limited to: maxdepth=3; maxpagecount=20; withinhost=10.10.12.6
|   Found the following indications of potential DOM based XSS: 
|     
|     Source: eval("document.location.href = '"+b+"pos="+a.options[a.selectedIndex].value+"'")
|_    Pages: http://10.10.12.6:80/phpmyadmin/js/functions.js?ts=1365422810
| http-sql-injection: 
|   Possible sqli for queries:
|     http://10.10.12.6:80/?C=M%3BO%3DA%27%20OR%20sqlspider
|     http://10.10.12.6:80/?C=D%3BO%3DA%27%20OR%20sqlspider
|     http://10.10.12.6:80/?C=S%3BO%3DA%27%20OR%20sqlspider
|     http://10.10.12.6:80/?C=N%3BO%3DD%27%20OR%20sqlspider
|     http://10.10.12.6:80/?C=M%3BO%3DD%27%20OR%20sqlspider
|     http://10.10.12.6:80/?C=D%3BO%3DA%27%20OR%20sqlspider
|     http://10.10.12.6:80/?C=S%3BO%3DA%27%20OR%20sqlspider
|_    http://10.10.12.6:80/?C=N%3BO%3DA%27%20OR%20sqlspider
...
|     
|     Path: http://10.10.12.6:80/chat/
|     Form id: name
|     Form action: index.php
|     
|     Path: http://10.10.12.6:80/drupal/
|     Form id: user-login-form
|     Form action: /drupal/?q=node&destination=node
|     
|     Path: http://10.10.12.6:80/payroll_app.php
|     Form id: 
|_    Form action: 
...
|   Found the following possible CSRF vulnerabilities: 
|     
|     Path: http://10.10.12.6:8080/continuum/security/login.action;jsessionid=12qr1svyd39vtnacxq57izhmr
|     Form id: loginform
|     Form action: /continuum/security/login_submit.action;jsessionid=11uv0er5y3sgyujna22m9dkve
|     
|     Path: http://10.10.12.6:8080/continuum/security/login.action;jsessionid=12qr1svyd39vtnacxq57izhmr
|     Form id: loginform
|     Form action: /continuum/security/login_submit.action;jsessionid=11uv0er5y3sgyujna22m9dkve
|     
|     Path: http://10.10.12.6:8080/continuum/security/register.action;jsessionid=11uv0er5y3sgyujna22m9dkve
|     Form id: registerform
|     Form action: /continuum/security/register_submit.action;jsessionid=11uv0er5y3sgyujna22m9dkve
|     
|     Path: http://10.10.12.6:8080/continuum/security/login.action;jsessionid=12qr1svyd39vtnacxq57izhmr
|     Form id: loginform
|     Form action: /continuum/security/login_submit.action;jsessionid=11uv0er5y3sgyujna22m9dkve
|     
|     Path: http://10.10.12.6:8080/continuum/security/login_submit.action;jsessionid=11uv0er5y3sgyujna22m9dkve
|     Form id: loginform
|     Form action: /continuum/security/login_submit.action;jsessionid=11uv0er5y3sgyujna22m9dkve
|     
|     Path: http://10.10.12.6:8080/continuum/security/login.action;jsessionid=11uv0er5y3sgyujna22m9dkve
|     Form id: loginform
|     Form action: /continuum/security/login_submit.action;jsessionid=11uv0er5y3sgyujna22m9dkve
|     
|     Path: http://10.10.12.6:8080/continuum/security/passwordReset.action;jsessionid=11uv0er5y3sgyujna22m9dkve
|     Form id: passwordresetform
|     Form action: /continuum/security/passwordReset_submit.action;jsessionid=11uv0er5y3sgyujna22m9dkve
|     
|     Path: http://10.10.12.6:8080/continuum/security/register_submit.action;jsessionid=11uv0er5y3sgyujna22m9dkve
|     Form id: registerform
|     Form action: /continuum/security/register_submit.action;jsessionid=11uv0er5y3sgyujna22m9dkve
|     
|     Path: http://10.10.12.6:8080/continuum/security/passwordReset_submit.action;jsessionid=11uv0er5y3sgyujna22m9dkve
|     Form id: passwordresetform
|_    Form action: /continuum/security/passwordReset_submit.action;jsessionid=11uv0er5y3sgyujna22m9dkve
| http-slowloris-check: 
|   VULNERABLE:
|   Slowloris DOS attack
|     State: LIKELY VULNERABLE
